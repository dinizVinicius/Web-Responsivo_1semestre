  ...
  <?php
    ...
    try {
      ...
      if(!empty($result)) {
        ...
        echo "<br><b>Campo 01</b>: ". $result[0]['nome'];
        echo "<br><b>Campo 02</b>: ". $result[0]['capital'];
        echo "<br><b>Campo 03</b>: ". $result[0]['idioma'];
        echo "<br><b>Campo 04</b>: ". $result[0]['continente'];
        echo "<br><b>Campo 05</b>: ". $result[0]['populacao'];
        echo "<br><b>Campo 06</b>: ". $result[0]['lider_politico'];
        echo "<br><b>Campo 07</b>: ". $result[0]['religiao_dominante'];
        echo "<br><b>Campo 08</b>: ". $result[0]['PIB'];
        echo "<br><b>Campo 09</b>: ". $result[0]['IDH'];
      } 
      $dbh = null;
